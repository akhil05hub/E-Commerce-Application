...
const Women = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-400 to-pink-200 flex flex-col">
      <div className="container mx-auto px-20 text-center flex-grow">
        <h1 className="text-3xl font-bold text-center mb-6 p-5 bg-gradient-to-r from-pink-700 to-purple-800 text-transparent bg-clip-text">
          WOMEN'S DAILY DEALS
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {loading ? (
            ...
            womenProducts.map(({ id, title, price, image, category }) => (
              <div
                data-aos="flip-left"
                key={id}
