...
const Cards = () => {
  ...
  return (
    <div className="mt-52 bg-gradient-to-r from-gray-400 to-red-100">
      <div className="container mx-auto px-20 py-10">
        <h1 className="text-3xl font-bold text-center mb-8 p-5 bg-gradient-to-r from-red-700 to-pink-800 text-transparent bg-clip-text">DAILY DEALS</h1>
